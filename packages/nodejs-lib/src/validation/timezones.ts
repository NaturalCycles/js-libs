...
import type { IANATimezone } from '@naturalcycles/js-lib/types'

// List extracted from Wikipedia (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)
// with the "Factory" value removed as its not working with our toolings
const TIMEZONES_FROM_WIKI = [
  'Africa/Abidjan',
  'Africa/Accra',
  'Africa/Addis_Ababa',
  'Africa/Algiers',
 ...
 */
export const TIMEZONES = _uniq([...TIMEZONES_FROM_JS, ...TIMEZONES_FROM_WIKI])
